...
1. [Generate images using Imagen](#generate-images-using-imagen) (Line 1)
   1. 1 [Generate images using the Imagen models](#generate-images-using-the-imagen-models) (Line 10)
   1. 2 [Imagen configuration](#imagen-configuration) (Line 60)
2. [Imagen prompt guide](#imagen-prompt-guide) (Line 80)
   2. 1 [Prompt writing basics](#prompt-writing-basics) (Line 90)
   2. 2 [Generate text in images](#generate-text-in-images) (Line 150)
   2. 3 [Prompt parameterization](#prompt-parameterization) (Line 180)
   2. 4 [Advanced prompt writing techniques](#advanced-prompt-writing-techniques) (Line 210)
      2. 4.1 [Photography](#style-photography) (Line 220)
      2. 4.2 [Illustration and art](#style-illustration-art) (Line 300)
      2. 4.3 [Shapes and materials](#shapes-materials) (Line 350)
      2. 4.4 [Historical art references](#art-references) (Line 380)
      2. 4.5 [Image quality modifiers](#img-quality-modifiers) (Line 410)
      2. 4.6 [Aspect ratios](#aspect-ratios) (Line 440)
      2. 4.7 [Photorealistic images](#photorealistic) (Line 490)
3. [Model versions](#model-versions) (Line 600)

# Document Summary

This document provides a comprehensive guide on using Google's Imagen model for generating high-fidelity images from text prompts. It includes detailed instructions on generating images using different programming languages, configuring the Imagen model, and crafting effective prompts. The guide also covers advanced techniques for prompt writing, including photography and art styles, and provides information on different model versions available.

# 1. Generate images using Imagen
...
## 1.1 Generate images using the Imagen models
...
| ![photorealistic sample image 1](/static/gemini-api/docs/images/imagen/0_prompt-writing-basics_park_short.png) | ![photorealistic sample image 2](/static/gemini-api/docs/images/imagen/0_prompt-writing-basics_park_medium.png) | ![photorealistic sample image 3](/static/gemini-api/docs/images/imagen/0_prompt-writing-basics_park_long.png) |
|---|---|---|
...
| ![Imagen 3 short prompt example](/static/gemini-api/docs/images/imagen/imagen3_short-prompt.png) | ![Imagen 3 long prompt example](/static/gemini-api/docs/images/imagen/imagen3_long-prompt.png) |
|---|---|
...
## 2.4 Advanced prompt writing techniques
...
| ![photorealistic sample image 1](/static/gemini-api/docs/images/imagen/1_style-photography_coffee-beans.png) | ![photorealistic sample image 2](/static/gemini-api/docs/images/imagen/1_style-photography_chocolate-bar.png) | ![photorealistic sample image 3](/static/gemini-api/docs/images/imagen/1_style-photography_modern-building.png) |
|---|---|---|
...
| ![close up camera sample image](/static/gemini-api/docs/images/imagen/3_camera-proximity_close-up.png) | ![zoomed out camera sample image](/static/gemini-api/docs/images/imagen/3_camera-proximity_zoomed-out.png) |
|---|---|
...
| ![aerial photo sample image](/static/gemini-api/docs/images/imagen/4_camera-position_aerial-photo.png) | ![a view from underneath sample image](/static/gemini-api/docs/images/imagen/4_camera-position_from-below.png) |
|---|---|
...
| ![natural lighting sample image](/static/gemini-api/docs/images/imagen/5_lighting_natural-lighting.png) | ![dramatic lighting sample image](/static/gemini-api/docs/images/imagen/5_lighting_dramatic-lighting.png) |
|---|---|
...
| ![motion blur sample image](/static/gemini-api/docs/images/imagen/6_camera-settings_motion-blur.png) | ![soft focus sample image](/static/gemini-api/docs/images/imagen/6_camera-settings_soft-focus.png) |
|---|---|
...
| ![macro lens sample image](/static/gemini-api/docs/images/imagen/7_lens-types_macro-lens.png) | ![fisheye lens sample image](/static/gemini-api/docs/images/imagen/7_lens-types_fisheye-lens.png) |
|---|---|
...
| ![polaroid photo sample image](/static/gemini-api/docs/images/imagen/8_film-types_polaroid-portrait.png) | ![black and white photo sample image](/static/gemini-api/docs/images/imagen/8_film-types_bw-photo.png) |
|---|---|
| Prompt: a **polaroid portrait** of a dog wearing sunglasses | Prompt: **black and white photo** of a dog wearing sunglasses |

<sup>Image source: Each image was generated using its corresponding text prompt with the Imagen 3 model.</sup>

### 2.4.2 Illustration and art

- Prompt includes: *"A [art style or creation technique] of..."*
...
| ![art sample images](/static/gemini-api/docs/images/imagen/2_style-illustration1A.png) | ![art sample images](/static/gemini-api/docs/images/imagen/2_style-illustration1B.png) | ![art sample images](/static/gemini-api/docs/images/imagen/2_style-illustration1C.png) |
|---|---|---|
...
| ![art sample images](/static/gemini-api/docs/images/imagen/2_style-illustration2E.png) | ![art sample images](/static/gemini-api/docs/images/imagen/2_style-illustration2F.png) | ![art sample images](/static/gemini-api/docs/images/imagen/2_style-illustration2G.png) |
|---|---|---|
...
| ![shapes and materials example image 1](/static/gemini-api/docs/images/imagen/9_shapes-materials_duffel.png) | ![shapes and materials example image 2](/static/gemini-api/docs/images/imagen/9_shapes-materials_bird.png) | ![shapes and materials example image 3](/static/gemini-api/docs/images/imagen/9_shapes-materials_paper.png) |
|---|---|---|
...
### 2.4.3 Historical art references
...
| ![impressionism example image](/static/gemini-api/docs/images/imagen/10_historical-ref1_impressionism.png) | ![renaissance example image](/static/gemini-api/docs/images/imagen/10_historical-ref1_renaissance.png) | ![pop art example image](/static/gemini-api/docs/images/imagen/10_historical-ref1_pop-art.png) |
|---|---|---|
...
| ![corn example image without modifiers](/static/gemini-api/docs/images/imagen/11_quality-modifier2_no-mods.png) | ![corn example image with modifiers](/static/gemini-api/docs/images/imagen/11_quality-modifier2_4k-hdr.png) |
|---|---|
...
| ![aspect ratio example](/static/gemini-api/docs/images/imagen/aspect-ratios_4-3_piano.png) | ![aspect ratio example](/static/gemini-api/docs/images/imagen/aspect-ratios_4-3_fries.png) |
|---|---|
...
| ![aspect ratio example](/static/gemini-api/docs/images/imagen/aspect-ratios_3-4_hiking.png) | ![aspect ratio example](/static/gemini-api/docs/images/imagen/aspect-ratios_3-4_valley.png) |
|---|---|
...
|---|---|
| **Model code** | **Gemini API**<br/>`imagen-4.0-generate-001`<br/>`imagen-4.0-ultra-generate-001`<br/>`imagen-4.0-fast-generate-001` |
| **Supported data types** | **Input**<br/>Text<br/>**Output**<br/>Images |
| **Token limits** | **Input token limit**<br/>480 tokens (text)<br/>**Output images**<br/>1 to 4 (Ultra/Standard/Fast) |
...
| Property | Description |
|---|---|
| **Model code** | **Gemini API**<br/>`imagen-3.0-generate-002` |
| **Supported data types** | **Input**<br/>Text<br/>**Output**<br/>Images |
| **Token limits** | **Input token limit**<br/>N/A<br/>**Output images**<br/>Up to 4 |
